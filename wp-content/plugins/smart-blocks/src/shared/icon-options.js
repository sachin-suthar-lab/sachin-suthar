/**
 * Single source of truth for icon slugs. Mirrored from helpers.php icon library
 * so the editor SelectControl and the PHP render always agree on what's available.
 */
export const ICON_OPTIONS = [
	{ label: '— Pick an icon —', value: '' },
	...
	{ label: 'Terminal / CLI', value: 'terminal' },
...
/* Editor-side SVG previews. Keep tiny — these are for the editor only;
   render.php draws the final SVG on the front-end via the icon helper. */
const SVG = ( d ) => (
...
const PATHS = {
	...
	react:    '<circle cx="12" cy="12" r="2"/><ellipse cx="12" cy="12" rx="10" ry="4"/>',
	...
	linux:    '<ellipse cx="12" cy="17" rx="6" ry="3"/><path d="M9 12c0-3 1-7 3-7s3 4 3 7"/>',
